 ...
 *
 * <p>To integrate, create an instance of {@code IntentIntegrator_External} and call {@link #initiateScan()} and wait
 ...
 *   IntentResult scanResult = IntentIntegrator_External.parseActivityResult(requestCode, resultCode, intent);
 *   if (scanResult != null) {
 *     // handle scan result
 *   }
 ...
 *
 * <pre>{@code
 * IntentIntegrator_External integrator = new IntentIntegrator_External(yourActivity);
 ...
 * @author gcstang
 */
public class IntentIntegrator_External {

  public static final int REQUEST_CODE = 0x0000c0de; // Only use bottom 16 bits
  private static final String TAG = IntentIntegrator_External.class.getSimpleName();
  ...
  public IntentIntegrator_External(Activity activity) {
